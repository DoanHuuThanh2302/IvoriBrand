...
export const IconsWarning: React.FC<IconProps> = ({ width, height }) => {
  return (
    <svg
      width={width ? width : '60px'}
      height={height ? height : '60px'}
...
export const IconsEditUser: React.FC<IconProps> = ({ width, height }) => {
  return (
    <svg
      fill='#000000'
      width={width ? width : '60px'}
...
export const IconsFile: React.FC<IconProps> = ({ width, height }) => {
  return (
    <svg
